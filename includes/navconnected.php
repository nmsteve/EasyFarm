...
<div class="navbar-fixed">
 <nav class="navblack">
   ...
   <ul class="left hide-on-med-and-down">
     ...
     <li><a href="index.php" class="dark-text">EasyFarm</a></li>
   ...
   <ul  class="right hide-on-med-and-down">
     ...
     <li><a href="cart.php" class="dark-text baskett"><i class="material-icons">shopping_cart</i><span class="badge <?php if(!isset($_SESSION['item']) OR $_SESSION['item'] == 0) echo'hide'; ?>"><?= $_SESSION['item']; ?></span>
       </a></li>
