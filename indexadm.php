   ...
   <div class="container current-page">
      <nav>
        <div class="nav-wrapper">
          <div class="col s12">
            <a href="index.php" class="breadcrumb">EasyFarm</a>
            <a href="indexadm.php" class="breadcrumb">Admin Dashboard</a>
          </div>
        </div>
      </nav>
    </div>
  ...
  <div class="row">
           ...
           <div class="card horizontal">
             ...
             <div class="card-stacked">
              <div class="card-content">
                <p><a href="infoproduct.php" class="black-text">Products</a></p>
              </div>
         ...
         <div class="col s12 m4">
           <div class="card horizontal">
             ...
             <div class="card-stacked">
        <div class="card-content">
          <p><a href="products.php" class="black-text">Stock</a></p>
        </div>
             <div class="card-action">
         ...
         <div class="col s12 m4">
           <div class="card horizontal">
             ...
             <div class="card-stacked">
              <div class="card-content">
                <p><a href="allusers.php" class="black-text">Users</a></p>
              </div>
               <div class="card-action">
           ...
           <div class="card green lighten-1 horizontal">
             <div class="card-stacked">
              <div class="card-content">
               ...
               <div class="card-action">
                 <a class="pull-right btn" href="records.php">View All</a>
           ...
           <div class="card blue lighten-1 horizontal">
             <div class="card-stacked">
              <div class="card-content">
               ...
               <div class="card-action">
                 <a class="pull-right btn" href="orders.php">View All</a>
           ...
           <div class="card horizontal red lighten-1">
             <div class="card-stacked">
              <div class="card-content">
               ...
               <div class="card-action">
                 <a class="pull-right btn" href="user.php">View All</a>
